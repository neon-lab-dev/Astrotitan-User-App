...
const RaiseQuery = () => {
  ...
  const [raiseQuery, { isLoading }] = useRaiseQueryMutation();
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      const response = await raiseQuery(payload).unwrap();

      navigation.replace('RaiseQuerySuccess', { slug: response.data.ticketId });
    } catch (error: any) {
      console.log('RAISE QUERY ERROR:', error);
    }
  };
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View style={styles.formContainer}>
              ...
              <View>
                <SansText style={styles.label}>Attachment (Optional)</SansText>
