...
import PremiumRequiredModal from '../../../../AstrologersPage/PremiumRequiredModal/PremiumRequiredModal';

export const AstrologerCard = ({ item }: any) => {
  ...
  return (
    <AnimatedScreen>
      <TouchableOpacity
        onPress={() => {
          navigation.navigate('AstrologerDetailsScreen', { id: item._id });
        }}
        style={styles.card}
      >
        <View style={styles.cardTop}>
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              <SatoshiText style={styles.rating}> {item.rating}</SatoshiText>

              <SansText style={{ color: '#757575' }}>
