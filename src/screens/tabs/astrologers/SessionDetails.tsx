  ...
  return (
    <ScreenWrapper>
      <View style={styles.container}>
        <AppHeader>
          <AuthTitle
            title={sessionType === 'chat' ? 'Chat history' : 'Call history'}
          ></AuthTitle>
        </AppHeader>
            ...
            <View style={styles.summaryCard}>
              ...
              >
                {isSubscription ? (
                  <LinearGradient
                    ...
                    style={styles.subscriptionTag}
                  >
                    <SansText style={styles.subscriptionText}>
                      Subscription Session
                    </SansText>
                  </LinearGradient>
                ) : (
                  <View style={styles.trialTag}>
                    <SansText style={styles.trialText}>Trial Session</SansText>
                  </View>
                )}
              </View>
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statItem}>
                  ...
                  <SatoshiText style={styles.statValue}>{rating}</SatoshiText>
                </View>
              </View>
            </View>
          </View>
              ...
              <View style={styles.notesContainer}>
                {sessionNotes.map((note, index) => (
                  <View key={index} style={styles.noteRow}>
                    <SansText style={styles.bullet}>•</SansText>
