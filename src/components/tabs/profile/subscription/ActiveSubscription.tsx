  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.statusContainer}>
        <Ionicons name="checkmark-circle" color="#22C55E" size={16} />

        <SansText style={styles.statusText}>Active</SansText>
      </View>
      ...
      <Pressable style={styles.cancelButton} onPress={onCancel}>
        ...
        <SansText style={styles.cancelText}>Cancel Subscription</SansText>
      </Pressable>
